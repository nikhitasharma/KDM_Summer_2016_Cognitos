...
import edu.knowitall.openie.{OpenIE, OpenIECli}*/
//import edu.knowitall.openie.OpenIE
...
object OpenIERelationExtraction {/*
  def main(args: Array[String]) {
    ...
    val obj = new openie.OpenIE()
    val instances = obj.extract(sentence)
    //val newo=openie.Extraction(sentence)
//    val instances = (sentence)
